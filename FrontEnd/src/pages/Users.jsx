        ...
        <>
            <Box>
                <Flex align="center" justify="between" maxWidth="1540px" style={{ padding: '10px 0px 20px 0px' }}>
                    ...
                    <Flex gap="2">
                        <Button onClick={() => exportToExcel()}> <DownloadIcon style={{ marginRight: 10 }} /> Export to Excel</Button>
                        <Button onClick={() => setDialogOpen(true)}> <PlusCircledIcon style={{ marginRight: 10 }} /> Add New User</Button>
                    </Flex>
                </Flex>
                <Flex gap="4" pb="8">
                    <Box>
                    ...
                    <Button onClick={() => searchUser()}><MagnifyingGlassIcon style={{marginRight: 10}}/>Search</Button>
                    <Button onClick={() => resetSearch()}><ResetIcon style={{ marginRight: 10 }} /> Reset</Button>
                </Flex>
                <Box maxWidth="1540px">
